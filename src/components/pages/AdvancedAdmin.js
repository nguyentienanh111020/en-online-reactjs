...
function AdvancedAdmin() {
  ...
  const handleAdd = async (e) => {
    ...
    await setDoc(doc(db, "advanced", "no" + String(response)), {
      ...data,
    ...
    for (let i = 0; i < 3; i++) {
      await setDoc(
        doc(db, "advanced", "no" + String(response), "question", String(i)),
        {
    ...
    for (let i = 0; i < 3; i++) {
      await setDoc(
        doc(db, "advanced", "no" + String(response), "question 2", String(i)),
        {
    ...
    for (let i = 0; i < 3; i++) {
      await setDoc(
        doc(db, "advanced", "no" + String(response), "question 3", String(i)),
        {
    ...
    for (let i = 0; i < 3; i++) {
      await setDoc(
        doc(db, "advanced", "no" + String(response), "question 4", String(i)),
        {
    ...
    for (let i = 0; i < 3; i++) {
      await setDoc(
        doc(db, "advanced", "no" + String(response), "question 5", String(i)),
        {
