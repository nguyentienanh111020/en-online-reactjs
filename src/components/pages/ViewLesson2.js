...
function ViewLesson() {
  ...
  useEffect(() => {
    const getBeginner = async () => {
      const beginnerCollectionRef = collection(db, "intermediate");
  ...
  const query = collection(db, "intermediate");
    ...
    <div className="container">
      ...
      >
        <thead>
          <tr>
            <th colSpan={5}>
              <h2>All Intermediate Lessons</h2>
            </th>
          </tr>
        </thead>
        <thead>
            ...
            return (
              <tr>
                ...
                <td style={{ width: "5%" }}>
                  {beginner.title1}
                  <br />
                  <ChildrenList path={`intermediate/${beginner.id}/question`} />
                  <hr />
                  {beginner.title2}
                  <br />
                  <ChildrenList
                    path={`intermediate/${beginner.id}/question 2`}
                  />
                  <hr />
                  {beginner.title3}
                  <ChildrenList
                    path={`intermediate/${beginner.id}/question 3`}
                  />
                  <hr />
                </td>
              </tr>
